...
#
# source       : https://github.com/robotology/icub-main/blob/master/conf/FindIPOPT.cmake
#
# note (Robin) : Making a manual findIPOPT was easy for macOS.
#                However, I didn't want to bother covering each OS version, each kind of install.
#                This script has the advantage of being cross-platform.
#


if(NOT WIN32)
    message("-- On non Windows systems PkgConfig is needed to find IPOPT")
    ...
    if(PKG_CONFIG_FOUND)
        ...
        if(_PC_IPOPT_FOUND)
            message("-- Found IPOPT via PkgConfig" )
            ...
            foreach(_LIBRARY IN ITEMS ${_PC_IPOPT_LIBRARIES})
                ...
                # NOTE: Workaround for https://github.com/robotology/icub-main/issues/418
                if(${_LIBRARY}_PATH)
    ...
    if(NOT _PC_IPOPT_FOUND)
        message("-- PkgFind failed to find IPOPT. Searching manually...")
        ...
        find_library(IPOPT_LIBRARIES ipopt ${IPOPT_DIR}/lib ${IPOPT_DIR}/lib/coin)

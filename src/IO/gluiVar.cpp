...
//	varList.add(false, "showStrucGraph", "StrucGraph") =  "Show_TI_Structure";
    ...
    varList.add(0.0f, "tilt_face_angle_min", "") = "Para_Basic"; varList.find("tilt_face_angle_min")->visible = false;
    varList.add(0.0f, "tilt_face_angle_max", "") = "Para_Basic"; varList.find("tilt_face_angle_max")->visible = false;
    ...
    varList.add(1e-7f, "mosek_rbe_eps", "RBE Eps")  = "Para_ContactGraph";varList.find("mosek_rbe_eps")->visible = false;
    varList.add(0.0f, Vector2f(0, 1), "mosek_rbe_friction_coeff", "Friction")  = "Para_ContactGraph";
    varList.add(1e7f, "mosek_rbeForce_upperBound", "")  = "Para_ContactGraph";varList.find("mosek_rbeForce_upperBound")->visible = false;
    varList.add(0.1f, "slope_binarySearch_eps", "")  = "Para_ContactGraph";varList.find("slope_binarySearch_eps")->visible = false;
    varList.add(0.1f, "slope_bound_eps", "")  = "Para_ContactGraph";varList.find("slope_bound_eps")->visible = false;
    varList.add(int(4), "slope_num_init_sample", "")  = "Para_ContactGraph";varList.find("slope_num_init_sample")->visible = false;
    varList.add((int)100, "kmeans_iteration", "")  = "Para_ContactGraph";varList.find("kmeans_iteration")->visible = false;
